...
|------|------|--------|-------|
| Headlines | Plus Jakarta Sans | 700 / 800 | Tracking -0.02em. Use 800 for cover titles, 700 for slide titles. |
...
```html
<link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;500;700;800&family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
```
...
- **Content:** IRIS logotype (white SVG) centered horizontally, upper third.
  Below: deck title (Plus Jakarta Sans 800, white, 48-56px), subtitle line
...
- **Title:** "Agenda" — Plus Jakarta Sans 700, white, 36px, top-left area
...
- **Content:** Section number (Inter 500, Azure `#41A9F6`, 16px, letterspaced)
  above section title (Plus Jakarta Sans 800, white, 44-52px). Centered
...
- **Title:** Plus Jakarta Sans 700, Iris Navy, 28-32px, top-left with 64px
  top padding
...
- **Background:** Iris Navy (`#0F2647`)
- **Title:** Plus Jakarta Sans 700, white, 28px, top-left
- **KPI cards:** 2-4 cards in a row. Each card: `rgba(255,255,255,0.06)`
  background, 16px radius, 24px padding. Value in Plus Jakarta Sans 700,
...
- **Background:** Iris Navy (`#0F2647`)
- **Title:** Plus Jakarta Sans 700, white, 28px
...
- **Layout:** 50/50 or 60/40 split. Left column: text content (title + body
  ...
  or data card).
- **Title:** Plus Jakarta Sans 700, Iris Navy, 28px
...
- **Content:** Key takeaways as 3-4 bullet points (Inter 500, Iris Navy, 18px).
  Below: CTA block — action text (Plus Jakarta Sans 700, Gogolook Blue, 24px)
