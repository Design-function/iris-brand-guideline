...
- **Headings font:** Plus Jakarta Sans 500, -0.02em tracking
...
- **Headlines:** Plus Jakarta Sans, weight 500 (medium), tracking -0.02em. The medium weight is the brand standard for all headlines — it delivers a clear, confident feel that defines IRIS. Also use 300–500 for logotype and highlighted paragraphs.
...
- Plus Jakarta Sans 500 for headlines. Inter for supporting body.
...
- [ ] Headlines use Plus Jakarta Sans 500. Body uses Inter.
